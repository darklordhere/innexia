...
from innexiaBot import dispatcher, DRAGONS, DEMONS, LOGGER
from innexiaBot.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler

import innexiaBot.modules.helper_funcs.fun_strings as fun
...
✪ /decide can be also used with regex like: `Makima? <question>: randomly answer "Yes, No" etc.`

Some other regex filters are:
`goodmorning`, `good morning` or `goodnight`, `good night`.

Makima will reply random strings accordingly when these words are used!
