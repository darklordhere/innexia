...
async def hmm(_, message):
    ...
    if status == "ON" or status == "on" or status == "On":
        ...
        if not lol:
            await lel.edit("Makima AI Already Activated In This Chat")
            return
        await lel.edit(
            f"Makima AI Successfully Added For Users In The Chat {message.chat.id}"
        )
        ...
        if not Escobar:
            await lel.edit("Makima AI Was Not Activated In This Chat")
            return
        await lel.edit(
            f"Makima AI Successfully Deactivated For Users In The Chat {message.chat.id}"
        )
