...
PM_START_TEXT = """
🔆 `Hey`,`I am`[𝙈𝙖𝙠𝙞𝙢𝙖](https://telegra.ph/file/c6e014871e5dfc89b8ad2.jpg) `bot`
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="💕 Sᴜᴍᴍᴏɴ Mᴇ 💕", url="http://t.me/makimagroupbot?startgroup=true"),
    ],
]
...
def innexia_about_callback(update, context):
    ...
    if query.data == "innexia_":
        query.message.edit_text(
            text=""" MAKIMA - A bot to manage your groups with additional features!
            \nHere's the basic help regarding use of Makima Bot.
